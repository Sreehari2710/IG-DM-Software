...
import { Instagram, Lock, Mail, Eye, EyeOff, Loader2 } from 'lucide-react';
...
export default function SigninPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await axios.post(`${apiBase}/api/auth/login`, formData);
  ...
  return (
    <div className="aura-auth-scope">
      ...
      <div className="auth-layout">
        {/* Left Column: Editorial Side Panel */}
          ...
          <div className="signup-side-content">
            ...
            <div className="signup-headline-section" style={{ margin: 'auto 0' }}>
              ...
              <p className="signup-desc-text">
                Instagram DM & Comment automation platform designed to feel organic and increase customer loyalty.
              </p>
            </div>
        ...
        {/* Right Column: Sign In Card Panel */}
          ...
          <div className="auth-content-block">
            ...
            <div className="auth-card-aura">
              <div className="card-header-aura">
                <h2 className="card-title-aura">Welcome back</h2>
                <p className="card-subtitle-aura">Please enter your details to sign in</p>
              </div>
            ...
            <p className="footer-text-aura">
              ...
              <Link href="/signup" className="footer-link-aura">Create account</Link>
            </p>
