...
export const createCampaign = async (req, res) => {
    const { userId, name, type, links, messages, delayMin, delayMax, hourlyLimit } = req.body;
    ...
    try {
        ...
        const isDuplicate = existingCampaigns.some((c) => c.name.trim().toLowerCase() === name.trim().toLowerCase());
        if (isDuplicate) {
