...
async function launchContext(session, headless) {
    ...
    if (session.proxyUrl) {
        options.proxy = { server: session.proxyUrl };
    }
    let context;
    try {
...
// ─── Comment Bot ─────────────────────────────────────────────────────────────
async function runCommentBot(page, postUrl, comment) {
    try {
        ...
        const findVisibleElement = async (selectors) => {
...
// ─── DM Bot ──────────────────────────────────────────────────────────────────
async function runDMBot(page, username, message) {
    try {
...
export async function runInteraction(jobId) {
